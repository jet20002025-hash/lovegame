...
export default function GameDisplay({ gameUrl, title, className }: GameDisplayProps) {
  ...
  // Debug logging
  console.log('GameDisplay:', { gameUrl, isY8Game, isCoolMathGame, isEmbeddable })

  // Always show play button for Y8.com and CoolMathGames.com
  if (isY8Game || isCoolMathGame) {
    return (
  ...
  // For embeddable games, show iframe
  return (
